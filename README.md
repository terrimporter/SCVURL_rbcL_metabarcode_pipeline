...
rbcL cpDNA taxonomic assignments are made using the Ribosomal Database classifier v2.12 (RDP classifier) available from https://sourceforge.net/projects/rdp-classifier/ (Wang et al., 2007) using the rbcL classifier v4 reference dataset available from https://github.com/terrimporter/rbcLClassifier .
